...
-- Assignment Answers: Introduction to SQL and Basic Queries
...
-- 5. Fetch productName and quantityInStock from products table, sorted by buyPrice ascending and limited to 5 records
